  ...
  return (
    <section className="hero">
      <div className="banner">
        ...
        <p>
          Welcome to Anand Jyoti Foundation, an NGO dedicated to uplifting the
          marginalized and disadvantaged communities in the rural areas of
          Maharashtra, particularly in Melghat Tribal Area. We are a group of
          passionate individuals committed to making a difference in the areas
          of livelihood, health, and education.
        </p>
        <Link to={"/donate"} className="btn">
          Donate Now
        </Link>
